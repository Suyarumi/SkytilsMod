...
object AlignmentTaskSolver {
    ...
    init {
        TickTask(20, repeats = true) {
            if (!Skytils.config.alignmentTerminalSolver || !Utils.inDungeons || mc.thePlayer == null || (!SuperSecretSettings.azooPuzzoo && DungeonTimer.bossEntryTime == -1L || !Utils.equalsOneOf(
